...
\midrule
\textbf{Full Model (v2.6)} & \textbf{Stable} & \textbf{1.94} & \textbf{High} \\
...
\midrule
Full Model (v2.6) & Random (Controlled) & 1.94 & 0.52 & \textbf{PASS} \\
Ablated (No Heretics) & Random (None) & 0.00 & 0.00 & \textbf{COLLAPSE} \\
Full Model (v2.6) & \textbf{Homogeneous (0)} & \textbf{0.22} & \textbf{1.15} & \textbf{PASS (Robust)} \\
