# Mem4ristor v2.4 (Formal Research Release)
Implementation Kit (Computational Model)

> **Status**: Attractor Diversity Research Prototype (**v2.4**)  
...
## 🔬 Overview
Mem4ristor v2.4 is a **neuromorphic-inspired computational model** designed to investigate algorithmic uniformization (consensus collapse). Unlike classical oscillators, it integrates a dynamic doubt variable ($u$) and structural heretics to maintain deliberative diversity in simulated environments.
...
- `src/mem4ristor/`: Cœur algorithmique (Moteur v2.4 - Simulation).
...
- `results/`: Sorties automatisées (Données v2.4 et Visuels).
